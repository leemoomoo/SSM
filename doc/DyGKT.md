...
If the reader wants to know the details, please refer to the paper: *[DyGKT: Dynamic Graph Learning for Knowledge Tracing](https://arxiv.org/pdf/2407.20824)*. 

```bibtex
@article{cheng2024dygkt,
  ...
  journal={arXiv preprint arXiv:2407.20824},
  year={2024}
}
```