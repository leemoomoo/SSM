...
If the reader wants to know the details, please refer to the paper: *[Leveraging pedagogical theories to understand student learning process with graph-based reasonable knowledge tracing](https://dl.acm.org/doi/pdf/10.1145/3637528.3671853)*. 

```bibtex
@inproceedings{cui2024leveraging,
