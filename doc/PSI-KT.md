...
If the reader wants to know the details, please refer to the paper: *[Predictive, scalable and interpretable knowledge tracing on structured domains](https://arxiv.org/pdf/2403.13179)*. 

```bibtex
@article{zhou2024predictive,
